# Tech Stack — mach eine fussbal news app
...
## Data API
- Read: GET /app/mach-eine-fussbal-news-app/api/<file>
- Write: PUT /app/mach-eine-fussbal-news-app/api/<file>
...
- Fallback: localStorage (key: pulseos-app-mach-eine-fussbal-news-app)
...
- Dateiname: mach-eine-fussbal-news-app-backup-YYYY-MM-DD.json
